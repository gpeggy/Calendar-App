...
import { sampleEvents, myCalendars } from "@/data/sampleEvents"
...
export default function CalendarApp() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* Navigation Header - FIXED: Higher z-index and better positioning */}
      <header
      ...
      {/* Main Content - FIXED: Proper z-index and positioning */}
      <main className="relative z-10 h-[calc(100vh-88px)] w-full flex">
        {/* Sidebar - FIXED: Better backdrop and visibility */}
        <div
